...
| Compactar lista de movimientos financieros | Validando | 94% | `src/components/FinanceTracker.tsx`, `docs/PROGRESO_VEO.md` |
...
| Abrir detalle desde la fila de movimiento | Validando | 90% | `src/components/FinanceTracker.tsx`, `docs/PROGRESO_VEO.md` |
