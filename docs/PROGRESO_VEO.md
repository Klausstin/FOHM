...
| Backup y seguridad de datos | Implementando | 90% | Export JSON, CSV legible y validador local listos; falta probar descarga real antes de carga masiva y definir restauracion futura. |
