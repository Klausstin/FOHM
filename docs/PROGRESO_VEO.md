...
| --- | --- | ---: | --- |
| Finanzas | Implementando | 76% | Prioridad actual. No pasar a otros modulos grandes hasta dejarlo cerca de 90%. |
...
| Importador BBVA / Visa / CSV | Implementando | 80% | Seguir validando PDFs reales, CSV beta y modo historial Wallet sin impacto automatico en saldos. |
...
| Importar historial Wallet como aprendizaje | Validando | 90% | `src/features/finance/finance.import.ts`, `src/components/FinanceTracker.tsx` |
...
5. Exportar Wallet a CSV y cargarlo como historial de aprendizaje sin tocar saldos.
